# Dormant relay-extension option

The default Desktop panel no longer calls this extension. It was implemented
and tested for a self-managed relay, but never deployed to the Hosted community.
Retained as a future option, not a compatibility requirement. The earlier
protocol and validation record follows.
